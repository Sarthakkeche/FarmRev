    ...
    <nav className="bg-green-600 p-4 shadow-lg">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-6 text-white">
          <Link to="/buyer" className="hover:text-gray-200 transition">Home</Link>
          <Link to="/about" className="hover:text-gray-200 transition">About</Link>
          <Link to="/" className="hover:text-gray-200 transition">Message</Link>

          {token ? (
            <Link to="/buyer" className="hover:text-gray-200 transition">Dashboard</Link>
          ) : null}
      ...
      {isOpen && (
        <div className="md:hidden flex flex-col bg-green-700 text-white p-4 space-y-4">
          ...
          {token && <Link to="/buyer" onClick={() => setIsOpen(false)}>Dashboard</Link>}
